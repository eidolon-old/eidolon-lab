...
public class Parser {
    ...
    /**
     * Parse a config input string into it's abstract syntax tree (AST)
     *
     * @param input The input string to parse
     * @return The parsed config AST
     * @throws ParserException upon an error in parsing
     */
    fun parse(input: String): ConfigObject {
        val context = ParserContext(input.trim().toCharArray())
        val mechanism = ParserMechanism(context)
    ...
    private inner class ParserMechanism(private val context: ParserContext) {
